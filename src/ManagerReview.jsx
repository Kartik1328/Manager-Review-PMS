...
const [commentMng1, setCommentsMng1] = useState([])
useEffect(() => {
  axios.get("http://localhost:8080/api/getByManagerAsm/20")
    .then((response) => {
...
console.log(commentMng1,"commentMng1")

const ratingArr1 = typeof ratingMng1 === 'string' ? ratingMng1.split(",") : [];
const commentArr1 = (typeof commentMng1 === 'string' && commentMng1 !== '') ? commentMng1.split(",") : [];
  ...
  {/* BUT WHEN THERE IS A OBJECT WE NEED NOT TO CREATE MAP FUNCTION LIKE ABOVE FROM LINE 345-360 WE CAN SIMPLY DO LIKE THIS -value={comments.frdRatings}, value={comments.frdComments} */}
        ...
        <div className='col-span-3 -mt-1 space-y-11  ml-10 '>
            <div className='space-y-1'>
              ...
              {/* <h3 className='text-gray-500 text-sm'>Comment</h3> */}
...
<div className='col-span-3 -mt-1 space-y-11 ml-12 '>
          ...
          <div className='-ml-[920px] pb-8 pt-32'>
